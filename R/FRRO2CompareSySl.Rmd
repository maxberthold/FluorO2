...
O2Slopes <- O2Slopes %>%
  ...
  mutate(O2evln_O2ls = ((O2_umolLs - O2_umolLs[1]) * photons_umol)) %>%
  # nest() %>%
...
```{r}
O2FRRfMeta <- left_join(x = FRRfData, y = O2SlopesClean, by = c("ObsDate", "CultureID", "Ex_WL", "Exp_Type" = "GrowthLight", "ActPARCorr" = "ActPARCorrinter"), suffix = c("FRRf", "O2"), keep = FALSE) %>%
