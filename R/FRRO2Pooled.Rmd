...
O2FRRfPool %>%
  filter(Dark1s == 0,
         Ex_WL == 445) %>%
  ggplot() +
  geom_point(aes(x = ActPAR, y = O2evln_O2ls, colour = as.factor(TempCont))) +
...
O2FRRfPool %>%
  ...
  geom_smooth(aes(x = ActPAR, y = JVPSII_aLHIIminmax, colour = as.factor(TempCont)), method = "lm") +
  #scale_colour_manual(values = Colours_nm) +
...
O2FRRfPool %>%
  ...
  geom_smooth(aes(x = JVPSII_aLHIIdark, y = JVPSII_aLHIIminmax, colour = as.factor(TempCont)), method = "lm") +
  #scale_colour_manual(values = Colours_nm) +
...
O2FRRfPool %>%
  filter(Dark1s == 0,
         ...
         ActPAR != 0) %>%
  ggplot() +
  geom_point(aes(x = ETRCtau1, y = ETRqp, colour = as.factor(Ex_WL))) +
  geom_smooth(aes(x = ETRCtau1, y = ETRqp, colour = as.factor(Ex_WL)), method = "lm") +
  #scale_colour_manual(values = Colours_nm) +
  #facet_grid(rows = vars(Ex_WL)) +
  coord_fixed(ratio = 1) +
  theme_bw()
...
O2FRRfPool %>%
  filter(Dark1s == 0,
         ...
         ActPAR != 0) %>%
  ggplot() +
  geom_point(aes(x = ETRCtau1, y = ETRCtau2, colour = as.factor(Ex_WL))) +
  geom_smooth(aes(x = ETRCtau1, y = ETRCtau2, colour = as.factor(Ex_WL)), method = "lm") +
  #scale_colour_manual(values = Colours_nm) +
  #facet_grid(rows = vars(Ex_WL)) +
  coord_fixed(ratio = 1) +
  theme_bw()
...
O2FRRfPool %>%
  filter(Dark1s == 0,
         ...
         ActPAR != 0) %>%
  ggplot() +
  geom_point(aes(x = ETRqp, y = ETRCtau2, colour = as.factor(Ex_WL))) +
  geom_smooth(aes(x = ETRqp, y = ETRCtau2, colour = as.factor(Ex_WL)), method = "lm") +
  #scale_colour_manual(values = Colours_nm) +
  #facet_grid(rows = vars(Ex_WL)) +
  coord_fixed(ratio = 1) +
  theme_bw()
...
#   geom_point(aes(x = O2FRRfPool %>% filter(Dark1s == 0) %>% filter(TempCont == "noTC") %>% pull(JVPSII_aLHIIminmax), y =  O2FRRfPool %>% filter(Dark1s == 0) %>% filter(TempCont == "TC") %>% pull(JVPSII_aLHIIminmax))) +
#   #scale_colour_manual(values = Colours_nm) +
...
O2FRRfPool %>%
  filter(Dark1s == 0,
         ...
         ActPAR != 0) %>%
  ggplot() +
  geom_point(aes(x = O2evln_O2ls, y = JVPSII_aLHIIminmax, colour = as.factor(TempCont))) +
  geom_smooth(aes(x = O2evln_O2ls, y = JVPSII_aLHIIminmax, colour = as.factor(TempCont)), method = "lm") +
  #facet_grid(rows = vars(Ex_WL)) +
  theme_bw()
...
O2FRRfPool %>%
  filter(Dark1s == 0,
         ...
         ActPAR != 0) %>%
  ggplot() +
  geom_point(aes(x = O2evln_O2ls, y = JVPSII_aLHIIdark, colour = as.factor(TempCont))) +
  geom_smooth(aes(x = O2evln_O2ls, y = JVPSII_aLHIIdark, colour = as.factor(TempCont)), method = "lm") +
  #facet_grid(rows = vars(Ex_WL)) +
  theme_bw()
...
O2FRRfPool %>%
  filter(Dark1s == 0,
         ...
         ActPAR != 0) %>%
  ggplot() +
  geom_point(aes(x = O2evln_O2ls, y = JVPSII_ETRtau1, colour = as.factor(TempCont))) +
  geom_smooth(aes(x = O2evln_O2ls, y = JVPSII_ETRtau1, colour = as.factor(TempCont)), method = "lm") +
  #facet_grid(rows = vars(Ex_WL)) +
  theme_bw()
