...
O2FRRfPool %>%
  filter(Dark1s == 0) %>%
  ggplot() +
  geom_point(aes(x = ActPARCorr, y = JVPSII_aLHIIminmax, colour = as.factor(TempContO2O2))) +
  geom_smooth(aes(x = ActPARCorr, y = JVPSII_aLHIIminmax, colour = as.factor(TempContO2)), method = "lm") +
  #scale_colour_manual(values = Colours_nm) +
...
O2FRRfPool %>%
  filter(
         ...
         ActPARCorr != 0) %>%
  ggplot() +
  geom_point(aes(x = JVPSII_aLHIIdark, y = JVPSII_aLHIIminmax, colour = as.factor(TempContO2))) +
  geom_smooth(aes(x = JVPSII_aLHIIdark, y = JVPSII_aLHIIminmax, colour = as.factor(TempContO2)), method = "lm") +
  #scale_colour_manual(values = Colours_nm) +
