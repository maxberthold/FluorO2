...
-'Header' or 'Meta' data rows at top of file are incorrectly included as 'data'
...
#Remove supefluous columns from working dataframe; be careful!
...
We have code to import and tidy a file from the PyroOxyLog Oxygen Optode monitoring system.
...
#fixed 'Skip' is brittle; better to start reading all data starting at line that contains 'key'
Skip <- 13
Comment <- "#"
